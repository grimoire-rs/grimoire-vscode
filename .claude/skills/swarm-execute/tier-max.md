...
**Gate**: `npm run check` passes (lint + type-check + build — cross-module implications surface immediately).
...
**Gate**: Tests compile/parse, fail with `unimplemented`. Coverage matches design record's edge-case list verbatim.

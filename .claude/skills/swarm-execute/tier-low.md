...
Read plan artifact from `.claude/artifacts/` (or extract scope from free-text target). Parse Stub / Specify / Implement / Review steps. Identify single module touched; read the matching Architecture notes in `CLAUDE.md` inline.

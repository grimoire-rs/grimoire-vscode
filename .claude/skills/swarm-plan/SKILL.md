...
- ALWAYS init plan with `## Status` block (Step `/swarm-plan → plan-approved`) and write `.claude/state/current_plan.md` pointer — schema + mutation table → [`plan-status.md`](../../rules/plan-status.md)
